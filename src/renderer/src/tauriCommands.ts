...
import type { MidiDevice } from '@renderer/utils/midi';
import type {
  ButtonSpec,
  MappingChoice,
  MappingDraft,
...
type Commands = {
  ...
  arm_midi_slot: { args: { port: string; slot: MappingSlot }; returns: MappingDraft };
  cancel_render: { args: Record<string, never>; returns: void };
  clear_midi_slot: { args: { port: string; slot: MappingSlot }; returns: MappingDraft };
  confirm_quit: { args: Record<string, never>; returns: void };
  disarm_midi_slot: { args: { port: string }; returns: MappingDraft };
  discard_midi_draft: { args: { port: string }; returns: void };
  ...
  list_midi_devices: { args: Record<string, never>; returns: MidiDevice[] };
  ...
  midi_mapping_draft: { args: { port: string }; returns: MappingDraft };
  midi_mappings: { args: Record<string, never>; returns: MappingChoice[] };
  midi_vocabulary: { args: Record<string, never>; returns: MidiVocabulary };
  ...
  press_cue: { args: { deck: string }; returns: DeckSyncPayload };
  ...
  release_cue: { args: { deck: string }; returns: DeckSyncPayload };
  ...
  save_midi_mapping: { args: { port: string }; returns: string | null };
  save_recording: {
  ...
  seek: { args: { deck: string; sec: number }; returns: DeckSyncPayload };
  ...
  set_loop_active: { args: { deck: string; active: boolean }; returns: DeckSyncPayload };
  set_loop_in: { args: { deck: string }; returns: DeckSyncPayload };
  set_loop_out: { args: { deck: string }; returns: DeckSyncPayload | null };
  ...
  set_midi_device_mapping: { args: { port: string; mapping: string | null }; returns: void };
  set_midi_monitor: { args: { enabled: boolean }; returns: void };
  set_midi_slot_button: {
    args: { port: string; slot: MappingSlot; button: ButtonSpec };
    returns: MappingDraft;
  };
