...
```json
{
  ...
  "events": [
    { "elapsed_ms": 0,      "frame": 0, "type": "recording_start", "buffer_size_frames": 117.6, "sample_rate": 44100 },
...
| ------------------------ | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `recording_start`        | `buffer_size_frames`, `sample_rate`                                                                                  | first event. Frames the callback actually delivered, which is fractional when the device is clocked at another rate, and the rate `frame` counts in |
