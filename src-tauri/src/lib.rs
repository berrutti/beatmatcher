...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::midi_vocabulary,
            commands::midi_mappings,
            commands::set_midi_device_mapping,
            commands::start_midi_learn,
            commands::stop_midi_learn,
            commands::arm_midi_slot,
            commands::disarm_midi_slot,
            commands::clear_midi_slot,
            commands::set_midi_slot_button,
            commands::midi_mapping_draft,
            commands::discard_midi_draft,
            commands::save_midi_mapping,
